  ...
  @Entity public class AdditionalDetails {
  
  @Id
  
  @GeneratedValue(strategy = GenerationType.SEQUENCE) private Long id; private
  String spokenLanguage; private String symbolUrl; private String
  symbolFilename;
  
  @ManyToOne(cascade = CascadeType.ALL)
  
  @JoinColumn(name="language_id", referencedColumnName= "id") private Languages
  language;
  ...
  public void setSpokenLanguage(String spokenLanguage) { this.spokenLanguage =
  spokenLanguage; }
  ...
  public String getSymbolFilename() { return symbolFilename; }
  
  public void setSymbolFilename(String symbolFilename) { this.symbolFilename =
  symbolFilename; }
